...
|Kronecker moments | Verifies the correctness of the explicit formula for the kronecker moment of a given order derived in our paper by comparing it to the corresponding empirical kronecker moment| 
